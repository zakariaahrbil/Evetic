        ...
        implements TicketService
{
    ...
    @Override
    public Ticket getTicketForOwner(UUID ticketId, UUID ownerId)
    {
        return ticketRepo.findByIdAndOwnerId(ticketId, ownerId)
                .orElseThrow(() -> new TicketNotFoundException("Ticket with ID " + ticketId + " not found for owner ID " + ownerId));
    }
}
